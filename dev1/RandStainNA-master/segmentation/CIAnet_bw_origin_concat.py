...
from CIAnet_bw_origin_concat import *
import scipy.io
...
class CIAnet_bw_origin_concat(nn.Module):
    def __init__(self, growthRate, nDenseBlocks, reduction, bottleneck):
        super(CIAnet_bw_origin_concat, self).__init__()               
        self.bw = bw()
        nChannels = 2*growthRate
        self.conv1 = nn.Conv2d(9, nChannels, kernel_size=3, padding=1, bias=False)#9.22改通道数为9
