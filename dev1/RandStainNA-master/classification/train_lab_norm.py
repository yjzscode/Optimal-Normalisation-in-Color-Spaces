...
from torchvision.models import resnet18, resnet18_lab_norm, resnet50, mobilenet_v3_large, mobilenet_v3_small#, efficientnet_b0 9.11
...
def main():
    ...
    elif args.model == 'resnet18_lab_norm':#9.11
        model = resnet18_lab_norm(num_classes=args.num_classes)
        _logger.info('torchvision.resnet18_lab_norm \n')
    else:
