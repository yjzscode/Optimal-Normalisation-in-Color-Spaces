...
from CIAnet_bw_origin_hsv import *
import scipy.io
...
mean_0 = (4.8756,0.4016,0.5936) #9.11添加hsv_norm初始值，依据是chosen template中表现最好的一张，之后可用数据集平均值
std_0 = (0.6663,0.2332,0.2112)
...
class CIAnet_bw_origin_hsv(nn.Module):
    def __init__(self, growthRate, nDenseBlocks, reduction, bottleneck):
        super(CIAnet_bw_origin_hsv, self).__init__()               
        self.bw = bw()
