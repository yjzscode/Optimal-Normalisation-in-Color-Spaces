...
if __name__ == '__main__':
    ...
    base_dir = '/root/autodl-tmp/RandStainNA-master/segmentation/results'
    ...
    model = CIAnet_bw_origin_concat(growthRate=6, nDenseBlocks=[6,12,24,16], reduction=0.5, bottleneck=True).to(device)
