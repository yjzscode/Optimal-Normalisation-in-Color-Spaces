...
# baseline
#hsv
# python CIA-bw_hsv_norm.py \
# --dataset $dataset_path \
# --epochs $ep --batch-size $b \
# --lr $lr \
# --output baseline_hsv_norm_addOrigin
# --seed 97 \
# --workers $workers\

python CIA-bw_concat.py \
--dataset $dataset_path \
--epochs $ep --batch-size $b \
--lr $lr \
--output baseline_concat_ep30
--seed 97 \
--workers $workers\
...
--lr $lr \
--output baseline_concat_ep60
--seed 97 \
--workers $workers\

# python CIA-bw_hsv_norm-Copy1.py \
# --dataset $dataset_path \
# --epochs 60 --batch-size $b \
# --lr $lr \
# --output baseline_hsv_norm_norigin60
# --seed 97 \
# --workers $workers\

# #hed
# python CIA-bw_hed_norm.py \
# --dataset $dataset_path \
# --epochs $ep --batch-size $b \
# --lr $lr \
# --output baseline_hed_norm_addOrigin
# --seed 97 \
# --workers $workers\

# python CIA-bw_hed_norm-Copy1.py \
# --dataset $dataset_path \
# --epochs $ep --batch-size $b \
# --lr $lr \
# --output baseline_hed_norm_norigin30
# --seed 97 \
# --workers $workers\
...
# --epochs 60 --batch-size $b \
# --lr $lr \
# --output baseline_hed_norm_norigin60
# --seed 97 \
# --workers $workers\
